...
@#$#@#$#@
<experiments>
  <experiment name="vary_pop" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="60"/>
    ...
    <steppedValueSet variable="max-vision" first="1" step="1" last="6"/>
  </experiment>
  <experiment name="vary_vision_pop" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="60"/>
    <metric>mean [metabolism] of turtles</metric>
